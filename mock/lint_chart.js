...
var sys_list = ['ap_sys', 'wcn_sys', 'gpu_sys', 'mm_sys', 'top']
...
var lint_p0 = ['0', '6', '20', '30', '50', '100', '200', '500', '55', '81', '60', '77']
var lint_p1 = ['0', '6', '20', '30', '50', '100', '200', '500', '55', '81', '60', '77']
for (let i = 0; i < count; i++) {
  ...
  List.push(Mock.mock({
    ...
    params_chk_war: '26',
    spylint_bui: 'SE',
    spylint_p0: regr_data.lint_p0,
    spylint_p1: regr_data.lint_p1,
    spylint_p2: '30',
    lop_com: '50',
    spysdc_bui: 'SE',
    spysdc_p0: '0',
...
export default [
  {
    ...
    response: config => {
      ...
      const { proj_name, page = 1, limit = 30, sort, subsys, topmodule, tag, owner, submitter, timestamp } = config.query
      ...
      console.log('Time: 06-24 timestamp is :', timestamp)
      ...
      if (timestamp !== null) {
        console.log('Time: 06-24 flag_here')
        mockList = mockList.sort(sortFun('timestamp', false))
        console.log('Time: 06-24 mockList is :', mockList)
      }
