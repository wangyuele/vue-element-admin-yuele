<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.sort" size="small" style="width: 140px;padding:2px" class="filter-item" @change="handleFilter">
    ...
    >
      <el-table-column label="ID" prop="id" sortable="custom" align="center" width="65" :class-name="getSortClass('id')">
      ...
      <el-table-column label="FileList" header-align="center" align="center" width="50px" style="width: 10%;margin-top: 20px">
        <el-table-column label="Dup" header-align="center" align="center" width="55px">
          <template slot-scope="{row}">
      ...
      <el-table-column label="DefineChk" header-align="center" align="center" width="50px" style="width: 10%;margin-top: 20px">
        <el-table-column label="Red" header-align="center" align="center" width="55px">
          <template slot-scope="{row}">
      ...
      <el-table-column label="ParamsChk" header-align="center" align="center" width="50px" style="width: 10%;margin-top: 20px">
        <el-table-column label="Fat" header-align="center" align="center" width="55px">
          <template slot-scope="{row}">
      ...
      <el-table-column label="SpyLint" header-align="center" align="center" width="50px" style="width: 10%;margin-top: 20px">
        <el-table-column label="Bui" header-align="center" align="center" width="55px">
          <template slot-scope="{row}">
